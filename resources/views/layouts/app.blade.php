            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <nav class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('auction-history') }}" class="text-lg font-semibold text-gray-900">Riwayat Lelang</a>
                        <a href="{{ route('admin.dashboard') }}" class="text-lg font-semibold text-gray-900">Halaman Utama Admin</a>
                    </div>
